...
/*   Updated: 2024/12/19 23:51:21 by oel-moue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_ray(t_data *data, double distance, double ray_angle)
{
	...
	x_end = data->player->player_x * SQUAR_SIZE + distance * cos(ray_angle);
	y_end = data->player->player_y * SQUAR_SIZE + distance * sin(ray_angle);
	printf("ray_angle: %f, distance: %f\n", ray_angle, distance);
	printf("x0: %f, y0: %f, x_end: %f, y_end: %f\n", x0, y0, x_end, y_end);
